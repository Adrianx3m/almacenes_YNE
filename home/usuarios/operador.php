<?php 
if(session_status()===PHP_SESSION_ACTIVE && isset($_SESSION['usuario']) && isset($_SESSION['aux']) && $_SESSION['aux']==="operador" && isset($_SESSION['limite']) && isset($_SESSION['nombre']) && $_SESSION['limite']>date_timestamp_get(date_create())){
 ?> 
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu">
              <li><button class="dropdown-item" href="#" id="a_inventarios">Productos</button></li>
...
<script>
  function cambiar_contenido(documento){
    ...
    const archivo = `usuarios/tareas_operador/${documento}.php`;
  ...
  document.querySelector('#a_inventarios').addEventListener("click",()=>{
    cambiar_contenido("operador_inventarios");
  })
